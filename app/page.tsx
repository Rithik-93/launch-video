...
export default function Home() {
  ...
  return (
    <div className="relative h-[100dvh] w-full bg-black overflow-hidden">
      ...
      {/* Content Overlay */}
      <div className="absolute bottom-16 sm:bottom-14 left-0 w-full px-6 sm:px-0 sm:left-1/2 sm:-translate-x-1/2 z-10 flex flex-col gap-10 sm:gap-0 sm:items-center">
